...
SPECS = [
    {
        "lines_year": 2022,
        "district_geojson": DATA_ROOT / "tileset" / "oh_cd118.geojson",
        "district_field": "CD118FP",
        "fallback_crosswalk": CROSSWALK_DIR / "precinct_to_cd118.csv",
        "outputs": {
            2010: CROSSWALK_DIR / "precinct_to_cd118_2010_vtd10.csv",
            2012: CROSSWALK_DIR / "precinct_to_cd118_2012_vtd10.csv",
            2014: CROSSWALK_DIR / "precinct_to_cd118_2014_vtd10.csv",
            2016: CROSSWALK_DIR / "precinct_to_cd118_2016_vtd10.csv",
            2018: CROSSWALK_DIR / "precinct_to_cd118_2018_vtd10.csv",
            2020: CROSSWALK_DIR / "precinct_to_cd118_2020_vtd10.csv",
        },
    },
    {
        "lines_year": 2024,
        "district_geojson": DATA_ROOT / "tileset" / "oh_cd119.geojson",
        "district_field": "CD119FP",
        "fallback_crosswalk": CROSSWALK_DIR / "precinct_to_cd119.csv",
        "outputs": {
            2010: CROSSWALK_DIR / "precinct_to_cd119_2010_vtd10.csv",
            2012: CROSSWALK_DIR / "precinct_to_cd119_2012_vtd10.csv",
            2014: CROSSWALK_DIR / "precinct_to_cd119_2014_vtd10.csv",
            2016: CROSSWALK_DIR / "precinct_to_cd119_2016_vtd10.csv",
            2018: CROSSWALK_DIR / "precinct_to_cd119_2018_vtd10.csv",
            2020: CROSSWALK_DIR / "precinct_to_cd119_2020_vtd10.csv",
        },
    },
    {
        "lines_year": 2026,
        ...
        "fallback_crosswalk": CROSSWALK_DIR / "precinct_to_cd2026_sl2025_95.csv",
        "outputs": {
            2010: CROSSWALK_DIR / "precinct_to_cd2026_2010_vtd10.csv",
            2012: CROSSWALK_DIR / "precinct_to_cd2026_2012_vtd10.csv",
            2014: CROSSWALK_DIR / "precinct_to_cd2026_2014_vtd10.csv",
            2016: CROSSWALK_DIR / "precinct_to_cd2026_2016_vtd10.csv",
            2018: CROSSWALK_DIR / "precinct_to_cd2026_2018_vtd10.csv",
            2020: CROSSWALK_DIR / "precinct_to_cd2026_2020_vtd10.csv",
        },
    },
]
...
def main() -> None:
    ...
    for spec in SPECS:
        ...
        for year, output_path in spec["outputs"].items():
            ...
            key = f"congressional_{spec['lines_year']}_{year}_vtd10"
            build_summary[key] = {
                "lines_year": spec["lines_year"],
                "year": year,
                "source": str(source),
    ...
    manifest_path = CROSSWALK_DIR / "historical_congressional_crosswalk_manifest.json"
